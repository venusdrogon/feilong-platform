 ...
 * @see OnewayType
 */
public abstract class AbstractOnewayEncryption implements OnewayEncryption{

	/**
	 * @return
	 */
	protected abstract OnewayType getOnewayType();

 
	public String encode(String origin) throws NullPointerException,EncryptionException{
	 ...
	 */
	public String encode(String origin,String charsetName) throws NullPointerException,EncryptionException{
	 ...
	 */
	public String encode(byte[] inputBytes) throws NullPointerException,EncryptionException{
		MessageDigest messageDigest = getMessageDigest(getOnewayType());
	 ...
	 */
	public String encodeFile(String filePath) throws IllegalArgumentException,EncryptionException{
