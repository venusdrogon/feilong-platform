...
public final class IOUtil{
    ...
    public static String inputStream2String(InputStream inputStream,String charsetName){
        try{
            BufferedReader bufferedReader = inputStream2BufferedReader(inputStream, charsetName);
     ...
     * @since 1.0.9
     */
    public static BufferedReader inputStream2BufferedReader(InputStream inputStream,String charsetName) throws UnsupportedEncodingException{
