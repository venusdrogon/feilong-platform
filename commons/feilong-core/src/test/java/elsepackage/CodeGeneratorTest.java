...
public class CodeGeneratorTest{
	...
	/**
	 * Test method for {@link com.CodeGenerator.shop.utils.SalesOrderCodeGenerator#createOrderCode(java.lang.Long)}.
	 */
	@Test
...
//		log.info(CodeGenerator.createOrderCode(111121L, 5555555L));
//		log.info(CodeGenerator.createOrderCode(1L, 5555555L));
//		log.info(CodeGenerator.createOrderCode(10L, 5L));
//		log.info(CodeGenerator.createOrderCode(101L, 5555555L));
//		log.info(CodeGenerator.createOrderCode(DateUtil.string2Date("2013-01-01 00:08:02", DatePattern.commonWithTime), 1L, 5555555L));
//		log.info(CodeGenerator.createOrderCode(DateUtil.string2Date("2020-11-11 12:31:23", DatePattern.commonWithTime), 111141L, 5555555L));
...
//		log.info(CodeGenerator.createOrderCode(DateUtil.string2Date("2035-04-22 08:31:35", DatePattern.commonWithTime), 203881L, 5555555L));
//		log.info(CodeGenerator.createOrderCode(DateUtil.string2Date("2044-12-31 10:21:46", DatePattern.commonWithTime), 35191L, 5555555L));
	}
}
