 ...
 * @version 1.1.2 2015年4月22日 下午1:44:06
 * @since 1.1.2
 */
public final class BankCodeNotSupportedException extends RuntimeException{
     ...
     * The Constructor.
     */
    public BankCodeNotSupportedException(){
        super();
    }
     ...
     *            the message
     */
    public BankCodeNotSupportedException(String message){
        super(message);
    }
     ...
     *            the args
     */
    public BankCodeNotSupportedException(String messagePattern, Object...args){
     ...
     *            the cause
     */
    public BankCodeNotSupportedException(String message, Throwable cause){
        super(message, cause);
    }
     ...
     *            the cause
     */
    public BankCodeNotSupportedException(Throwable cause){
        super(cause);
    }
}
