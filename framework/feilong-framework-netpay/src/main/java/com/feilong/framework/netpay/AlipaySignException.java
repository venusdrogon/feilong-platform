 ...
 * @version 1.1.2 2015年5月10日 下午10:01:52
 * @since 1.1.2
 */
public final class AlipaySignException extends RuntimeException{
     ...
     *            the message
     */
    public AlipaySignException(String message){
        super(message);
    }
     ...
     *            the args
     */
    public AlipaySignException(String messagePattern, Object...args){
     ...
     *            the cause
     */
    public AlipaySignException(String message, Throwable cause){
        super(message, cause);
    }
     ...
     *            the cause
     */
    public AlipaySignException(Throwable cause){
        super(cause);
    }
}