/*
 * Flexigrid for jQuery - New Wave Grid Copyright (c) 2008 Paulo P. Marinas
 * (webplicity.net/flexigrid) Dual licensed under the MIT (MIT-LICENSE.txt) and
 * GPL (GPL-LICENSE.txt) licenses. $Date: 2010/09/04 01:01:01 $
 */
(function($) {
