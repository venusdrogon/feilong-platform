 ...
 */
public class AlipayNetPayMobileAdaptorTest extends BasePaymentTest{

	private static final Logger	log	= LoggerFactory.getLogger(AlipayNetPayMobileAdaptorTest.class);

	@Autowired
	@Qualifier("alipayNetPayMobileAdaptor")
