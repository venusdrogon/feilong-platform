...
public class MandiriClickPayAdaptorTest extends AbstractJUnit4SpringContextTests{

	private static final Logger	log	= LoggerFactory.getLogger(MandiriClickPayAdaptorTest.class);
