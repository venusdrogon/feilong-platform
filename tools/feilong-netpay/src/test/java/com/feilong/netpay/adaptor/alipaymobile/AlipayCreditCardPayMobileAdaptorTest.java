 ...
 */
public class AlipayCreditCardPayMobileAdaptorTest extends BasePaymentTest{

	private static final Logger	log	= LoggerFactory.getLogger(AlipayCreditCardPayMobileAdaptorTest.class);

	@Autowired
	@Qualifier("alipayCreditCardMobileAdaptor")
	private PaymentAdaptor		paymentAdaptor;

	@Test
	public final void createPaymentForm(){
		String filePath = "F:/alipayCreditCardMobileAdaptor.html";
