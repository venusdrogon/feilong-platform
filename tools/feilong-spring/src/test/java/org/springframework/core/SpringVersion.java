 ...
 * Consider using a reflection-based check instead: For example, checking for the presence of a specific Spring 2.0 method that you intend to call.
 * 
...
public class SpringVersion{
	...
	/**
	 * Return the full version string of the present Spring codebase, or <code>null</code> if it cannot be determined.
	 * 
