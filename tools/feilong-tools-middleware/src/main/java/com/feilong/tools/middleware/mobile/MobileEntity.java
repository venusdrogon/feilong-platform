...
public class MobileEntity implements Serializable{
    ...
    /**
     * <pre>
     * 第二代手机通讯技术规格标准有: GSM：基于TDMA所发展、源于欧洲、目前已全球化。  	 IDEN：基于TDMA所发展、美国独有的系统。被美国电信系统商Nextell使用。  	 IS-136﹙也叫做D-AMPS﹚：基于TDMA所发展，是美国最简单的TDMA系统，用于美洲。  	 IS-95﹙也叫做cdmaOne﹚：基于CDMA所发展、是美国最简单的CDMA系统、用于美洲和亚洲一些国家。  	 PDC﹙Personal Digital Cellular﹚：基于TDMA所发展，仅在日本普及。   3G  目前3G存在四种标准：CDMA2000，WCDMA，TD-SCDMA，WiMAX。  3G标准：它们分别是WCDMA（欧洲版）、CDMA2000（美国版）和TD-SCDMA（中国版）。
     * </pre>
     * 
     * .
     */
