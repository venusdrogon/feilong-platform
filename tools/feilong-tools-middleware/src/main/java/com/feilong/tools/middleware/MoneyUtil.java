 ...
 * @version 1.0 2010-2-9 上午09:51:55
 * @since 1.0
 */
public class MoneyUtil{

	/** 中文的 0123456789. */
	private static char[]	s1	= { '零', '壹', '贰', '叁', '肆', '伍', '陆', '柒', '捌', '玖' };

	/**
	 * 中文的 分角元....
	 */
	private static char[]	s4	= { '分', '角', '元', '拾', '佰', '仟', '万', '拾', '佰', '仟', '亿', '拾', '佰', '仟', '万' };

	/**
	 * 将数字金额转换成中文大写<br>
	 * <code> 版本：0.1 2005-10-17 </code> <br>
	 * 附：《正确填写票据和结算凭证的基本规定》
	 * <p>
	 ...
	 * </li>
	 * <li>七、票据出票日期使用小写填写的,银行不予受理。大写日期未按要求规范填写的,银行可予受理,但由此造成损失的,由出票入自行承担。<br>
	 * </li>
	 * </ul>
	 * </p>
	 * </p>
	 ...
	 * @return 大写的金额
	 */
	public static String convertMoneyToChineseMoney(double money){
