 ...
 */
public class BrowsingHistoryCommandJDKTest implements Serializable,Comparable<BrowsingHistoryCommandJDKTest>{
	...
	public boolean equals(Object obj){
		...
		BrowsingHistoryCommandJDKTest browsingHistoryCommand = (BrowsingHistoryCommandJDKTest) obj;
	 ...
	 * @param date
	 */
	public BrowsingHistoryCommandJDKTest(String simpleSkuCommand, long date){
	 ...
	 */
	public int compareTo(BrowsingHistoryCommandJDKTest browsingHistoryCommand){
