...
public class TreeSetTest{
	...
	public void name(){
		...
		TreeSet<BrowsingHistoryCommandJDKTest> treeSet = new TreeSet<BrowsingHistoryCommandJDKTest>();
		for (int i = 0; i < 10; ++i){
			treeSet.add(new BrowsingHistoryCommandJDKTest("21500" + i, 17800L + i));
		}
		for (BrowsingHistoryCommandJDKTest browsingHistoryCommand : treeSet){
		...
		TreeSet<BrowsingHistoryCommandJDKTest> treeSet1 = new TreeSet<BrowsingHistoryCommandJDKTest>();
		treeSet1.addAll(treeSet);
		// Collections.sort()
		for (BrowsingHistoryCommandJDKTest browsingHistoryCommand : treeSet1){
			log.info("{}:{}", browsingHistoryCommand.getDate(), browsingHistoryCommand.getSimpleSkuCommand());
		}
	}
