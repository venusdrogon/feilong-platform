...
<link rel="stylesheet" href="${pageContext.request.contextPath }/res/feilong/js/plugins/jquery.ztree/zTreeStyle.css" type="text/css"></link>
<style type="text/css">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/res/feilong/js/plugins/jquery.ztree/jquery.ztree.all-3.5.js"></script>
