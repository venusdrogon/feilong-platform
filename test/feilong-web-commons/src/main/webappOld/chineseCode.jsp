...
<%
	...
	//字体
	String[] fontTypes = { "\u6977\u4f53_UTF-8", "\u534e\u6587\u884c\u6977" };
	...
	Color[] colors = { new Color(44, 188, 17), new Color(55, 55, 55), new Color(251,
								0,
								254) };
	...
	for (int i = 0; i < chineseCount; i++) {
		...
		//将此汉字画到图片上
		g.drawString(rand, 32 * i + 14 + random.nextInt(12), 28);
	}
